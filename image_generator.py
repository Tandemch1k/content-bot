...
BASE_STYLE = (
    "Professional real estate photography, Dubai UAE, "
    "photorealistic, 8K quality, golden hour lighting, "
    "luxury, high-end, architectural photography, "
    "vibrant colors, sharp details, no people, no text"
)
...
def generate_fal_image(image_prompt: str) -> Optional[str]:
    ...
    full_prompt = f"{image_prompt}. {BASE_STYLE}"
