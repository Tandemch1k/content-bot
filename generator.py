...
- Эмодзи ОБЯЗАТЕЛЬНО и много — 10-15 штук на пост, по смыслу каждого предложения
- Используй разные эмодзи: 🏠🏗️🔑💰📈📊🌟⚡️🎯💡🔥✅❌⚠️🤔💬👇🏆💎🌍✈️📍🏖️🌆🌇💸🤑📱💻🎉🙌👏
- Ставь эмодзи в начале абзацев, перед важными фактами, в списках
...
- СТРОГО до 800 символов включая эмодзи — это жёсткое ограничение
- 3-4 абзаца максимум, каждый 2-3 предложения
- БЕЗ хэштегов
...
Создай промпт на английском (15-25 слов) который описывает идеальное фото для этого поста.
Промпт должен быть конкретным: укажи место (Dubai Marina / Palm Jumeirah / Downtown Dubai / etc), тип объекта (luxury apartment / villa / penthouse / skyline), время суток, атмосферу.

Примеры хороших промптов:
- "Dubai Marina luxury penthouse interior, floor-to-ceiling windows, city view at sunset, modern furniture"
- "Palm Jumeirah aerial drone view, turquoise water, luxury villas, golden hour"
- "Downtown Dubai Burj Khalifa night skyline, lights reflection, luxury lifestyle"
- "Modern Dubai apartment open kitchen, marble countertops, sea view, minimalist design"
