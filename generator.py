...
- БЕЗ Markdown разметки — никаких *, **, _, __, `, []()
- Только обычный текст + эмодзи
- Эмодзи 8-12 штук по смыслу: 🏠🏗️🔑💰📈📊🌟⚡️🎯💡🔥✅❌🤔💬👇🏆💎🌍✈️📍🏖️🌆💸🤑🎉🙌😎🤝
- Районы: Dubai Marina, JBR, Business Bay, Downtown, Palm Jumeirah, Creek Harbour
- Застройщики: Emaar, Damac, Nakheel, Sobha, Aldar
- СТРОГО до 700 символов — это жёсткий лимит, не превышай
- Максимум 3 абзаца, каждый 2-3 предложения
- БЕЗ хэштегов, БЕЗ горизонтальных линий, БЕЗ заголовка "Telegram:"
"""

FOOTER = """

❓ Хотите выгодно инвестировать или купить жильё в Дубае? Пишите нам 👇
📸 instagram.com/juliia_mart  🎥 @top_family_dxb  ✈️ t.me/top_family_manager"""
...
ALL_TOPICS = [
    ...
    "Как выбрать управляющую компанию для сдачи в аренду в Dubai",
    "Что нужно знать об обслуживании недвижимости в Dubai",
    "Как открыть бизнес в Dubai при покупке недвижимости",
]
